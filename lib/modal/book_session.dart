...
class BookSession extends StatefulWidget {
  ...
  const BookSession({super.key, required this.number, required this.clientName, required this.pendingMassage});
...
class _BookSessionState extends State<BookSession> {
  ...
  static const List<String> list = <String>['Deep Tissue', 'Foot Massage', 'Aroma Massage', 'Full Body Massage'];
  @override
  void initState() {
    super.initState();
  }
          ...
          child: Column(
            ...
            children: [
              const SizedBox(height: 20),
                   CircleAvatar( maxRadius: MediaQuery.of(context).size.width/7, child: Image.asset("assets/business.png")),
              Row(
              ...
              Center(child: Text(manager,style: const TextStyle(fontSize: 20,fontWeight: FontWeight.w400),)),
            ...
            child: Column(
              children: [
                const Padding(
                  ...
                  child: Text("Choose a massage service",style: TextStyle(fontFamily: "Montserrat",fontSize: 20)),
                ),
                const SizedBox(height: 15),
