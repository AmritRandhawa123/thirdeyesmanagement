                        ...
                        children: [
                          ...
                          Row(
                            ...
                            children: const [
                             Icon(Icons.history),
                              SizedBox(width: 5,),
                              Text("Massage History",style: TextStyle(fontFamily: "Montserrat",fontWeight: FontWeight.bold),),
                            ],
                          ),
                          const SizedBox(height: 20),
                          ...
                          Padding(
                            ...
                            child: Row(
                              ...
                              const SizedBox(width: 5),
                                Text(widget.pastServices[index]["date"],style: const TextStyle(
                                    fontFamily: "Montserrat",
                          ...
                          Padding(
                            ...
                            child: Row(
                              children: [
                                const Text("Massage : " ),
                                Text(widget.pastServices[index]["massageName"],softWrap: true,style: const TextStyle(fontWeight: FontWeight.bold,fontFamily: "Montserrat")),
                              ],
                            ),
                          ),
                            ...
                            child: Row(
                              children:  [
                                ...
                                Flexible(
                                  ...
                                  child: Text(widget.pastServices[index]["subHeading"],softWrap: false,maxLines: 3,overflow: TextOverflow.ellipsis,style: const TextStyle(fontWeight: FontWeight.bold,fontFamily: "Montserrat")),
                                )],
                            ),
                          ),
                          Padding(
                            ...
                            child: Row(
                              children: [
                                const Text("Duration : ",),
                                Text(widget.pastServices[index]["duration"],style: const TextStyle(fontWeight: FontWeight.bold,fontFamily: "Montserrat")),
                              ],
                            ),
                          )
                        ],
              ...
              child: Center(
                  child: Text(widget.phoneNumber,
                      style: const TextStyle(
                          ...
                          fontFamily: "Montserrat")))),
          const SizedBox(height: 20),
          const Text("Registration", style: TextStyle(color: Colors.white60)),
          Text(
            widget.registration,
                ...
                Navigator.push(
                    ...
                    MaterialPageRoute(
                      ...
                      date: DateFormat.yMMMd().add_jm().format(Timestamp.now().toDate()),
                        duration: 1,
                        spaName: "Holistic Spa",
                        massageName: "Head Massage",
                        subHeading: "it will help you to relax mind with aroma oil",
                      ),
                    ));
              }
            },
